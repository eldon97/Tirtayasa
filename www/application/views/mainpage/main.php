            ...
            <div id="controlpanel" class="large-3 large-push-9 columns">
                ...
                <div class="row">
                    <div class="small-12 columns">
                        <a href="#">
                            <div data-alert data-reveal-id="shutdownModal" class="alert-box secondary center">
                                <b><?= $this->lang->line('KIRI is shutting down'); ?></b>
                            </div>
                        </a>
                        <div id="shutdownModal" class="reveal-modal small" data-reveal aria-hidden="true" role="dialog">
                            <h2><?= $this->lang->line('KIRI is shutting down') ?></h2>
                            <p><?= $this->lang->line('KIRI is shutting down / explanation') ?></p>
