...
class Api_model extends CI_Model {
	 ...
	 * @param float $distance The distance
	 */
	function calculatePrice($distance,$trackDetail) {
		$distance_in_meter = floor($distance * 1000);

		$oneMeterPrice = $trackDetail->tarifPerKm/1000;
		$minimalPrice = $trackDetail->tarifMinimal;
